# tax-doc-sdk-tax1099h

Software development kit to generate IRS Form 1099-H as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099H.sample.png" width="850"/>
